...
app.get('/ad/:id', async (req, res) => {
    ...
    // If it's a real user, open the app directly!
    if (!isBot(userAgent)) {
        ...
        const pageStyle = `*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',Roboto,Helvetica,sans-serif;background:#000;color:#fff;display:flex;align-items:center;justify-content:center;min-height:100vh;text-align:center;direction:rtl;background-image:radial-gradient(circle at 50% 0%,rgba(26,115,232,0.2) 0%,transparent 50%),radial-gradient(circle at 100% 100%,rgba(76,175,80,0.15) 0%,transparent 50%)}.container{padding:3rem 2rem;max-width:420px;width:90%;background:rgba(28,28,30,0.6);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:32px;border:1px solid rgba(255,255,255,0.1);box-shadow:0 25px 50px -12px rgba(0,0,0,0.5)}.app-icon-wrapper{width:110px;height:110px;background:#fff;border-radius:24px;box-shadow:0 12px 24px rgba(0,0,0,0.4);display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem;overflow:hidden;position:relative}.app-icon-wrapper::after{content:'';position:absolute;top:0;left:0;right:0;bottom:0;border-radius:24px;border:1px solid rgba(0,0,0,0.1)}.app-icon-wrapper img{width:85%;height:85%;object-fit:contain}h1{font-size:1.85rem;margin-bottom:0.5rem;font-weight:700;color:#fff;letter-spacing:-0.5px}p{color:#8E8E93;margin-bottom:2.5rem;font-size:1.1rem;line-height:1.5;padding:0 10px}.badges{display:flex;flex-direction:column;gap:14px;align-items:center}.store-badge{transition:transform 0.2s cubic-bezier(0.2,0.8,0.2,1),opacity 0.2s;display:inline-block}.store-badge:hover{opacity:0.9;transform:scale(1.02)}.store-badge:active{transform:scale(0.96)}.store-badge img{height:52px;display:block}`;

        const html = `<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>سوقكم SOOQCOM</title><style>${pageStyle}</style></head><body><div class="container"><div class="app-icon-wrapper"><img src="https://sooq-com.com/logo.png" alt="سوقكم"></div><h1>تطبيق سوقكم</h1><p>حمّل التطبيق الآن لتجربة أسرع وأفضل في تصفح الإعلانات</p><div class="badges"><a href="${playStoreUrl}" class="store-badge"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Get it on Google Play"></a><a href="itms-apps://apps.apple.com/app/sooqcom-%D8%B3%D9%88%D9%82%D9%83%D9%85/id6785620545" class="store-badge"><img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="Download on the App Store"></a></div></div></body></html>`;
