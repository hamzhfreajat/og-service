...
app.get('/ad/:id', async (req, res) => {
    ...
    if (!isBot(userAgent)) {
        ...
        const pageStyle = `*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#f4f7f6;color:#111827;display:flex;align-items:center;justify-content:center;min-height:100vh;text-align:center;direction:rtl}.container{padding:3.5rem 2.5rem;max-width:420px;width:90%;background:#ffffff;border-radius:28px;box-shadow:0 20px 40px rgba(0,0,0,0.06)}.logo{width:150px;height:auto;margin:0 auto 1.5rem;display:block;object-fit:contain}h1{font-size:1.75rem;margin-bottom:0.75rem;font-weight:800;color:#1A73E8;letter-spacing:-0.5px}p{color:#4b5563;margin-bottom:2.5rem;font-size:1.05rem;line-height:1.6}.badges{display:flex;flex-direction:column;gap:16px;align-items:center}.store-badge{transition:transform 0.2s ease,opacity 0.2s ease}.store-badge:hover{opacity:0.9}.store-badge:active{transform:scale(0.96)}.store-badge img{height:56px;display:block}`;

        const html = `<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>سوقكم SOOQCOM</title><style>${pageStyle}</style></head><body><div class="container"><img src="https://sooq-com.com/logo.png" alt="سوقكم SOOQCOM" class="logo"><h1>تطبيق سوقكم</h1><p>حمّل التطبيق الآن لتجربة أسرع وأفضل في تصفح الإعلانات</p><div class="badges"><a href="${playStoreUrl}" class="store-badge"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Get it on Google Play"></a><a href="itms-apps://apps.apple.com/app/sooqcom-%D8%B3%D9%88%D9%82%D9%83%D9%85/id6785620545" class="store-badge"><img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="Download on the App Store"></a></div></div></body></html>`;
